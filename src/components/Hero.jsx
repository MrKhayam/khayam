  ...
  return (
    <>
      <div className="w-[95%] mx-auto relative hero flex items-center justify-center flex-col gap-5">
        <h1 className="text-5xl font-bold leading-[60px] 2xl:text-7xl lg:leading-[80px]">
        ...
        <img
          src="/hero2.png"
          alt=""
          className="animate-up-down absolute bottom-[60%] left-[60px] lg:left-[180px] w-[100px] rotate-[-45deg]"
        />
        <img
          src="/elp1.png"
          alt=""
